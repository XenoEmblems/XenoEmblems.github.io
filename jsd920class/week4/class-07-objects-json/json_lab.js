...
//This passes the test of being valid JSON:
// {
//     "someKey": "someValue",
//     "innerArray": [
//         "alpha",
...
var grungeAlbumsParsed = JSON.parse(grungeAlbumsJSON, function(k, v){
    console.log(k +": " + v);
});

//This isnt perfect. How should I fix this.


JSON.parse(grungeAlbumsJSON, function(k, v) {
...
"movieActors":[
    ...
    },
    {
        ...
        "bestMovie": "Terminator",
        "rottenTomatoScore": 100
    }
]
}
